...
def display_in_container(title, value):
    ...
    # else:
        # value = str(value)  Already handled by f-string conversion
...
# Inside display_parsed_data()
    ...
    col1,col2,col3=st.columns([0.3,1.1,1.3])
    with col2:
        st.markdown(f"<h6 style='font-size: 20px; margin-top: 10px;'>Hi {Full_Name}! 😊</h6>", unsafe_allow_html=True)
